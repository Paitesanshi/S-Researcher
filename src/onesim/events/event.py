...
class Event:
    ...
    def __init__(self, 
        ...
        self.from_agent_id: str = str(from_agent_id)
        self.to_agent_id: str = str(to_agent_id)
        self.parent_event_id: Optional[str] = kwargs.get("parent_event_id", None)

        self.from_action: Optional[str] = kwargs.get("from_action", None)
        self.to_action: Optional[str] = kwargs.get("to_action", None)
        
        # Step tracking for round-based simulations
        self.step: Optional[int] = kwargs.get("step", None)
