...
class AliyunChatAdapter(ModelAdapterBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Auto-detected: some models (e.g. MiniMax) require enable_thinking=True.
        # We start with False and flip to True on first 400 error about this param.
    ...
    def __call__(
        ...
        **kwargs
        ...
        extra_body.setdefault("enable_thinking", self._requires_thinking)
        call_kwargs.update({
        ...
        try:
            ...
            if self._is_thinking_required_error(e) and not extra_body.get("enable_thinking"):
                ...
                try:
                    ...
                    logger.error(f"Aliyun chat sync call failed: {e2}")
                    raise
            else:
        ...
        try:
            ...
            if self._is_thinking_required_error(e) and not extra_body.get("enable_thinking"):
                ...
                try:
                    ...
                    logger.error(f"Aliyun chat async call failed: {e2}")
                    raise
            else:
    ...
    def _is_thinking_required_error(exc: Exception) -> bool:
        ...
        if status != 400:
            return False
        err_str = str(exc)
        return "enable_thinking" in err_str
