...
def media_bias_distribution(data: Dict[str, Any]) -> Dict[str, int]:
    """
    Metric: media_bias_distribution
...
def voter_media_selection_count(data: Dict[str, Any]) -> Dict[int, int]:
    """
    Metric: voter_media_selection_count
    Description: Counts how many voters have selected each media source, indicating preference alignment.
