...
class DetailerAgent(AgentBase):
    ...
    def __init__(self, model_config=None, paradigm_key: str = "paradigm_1"):
        ...
        Args:
            ...
            paradigm_key (str): The research paradigm (for prompt customization).
        """
        super().__init__("Detailer Agent", model_config)
        self.paradigm_key = paradigm_key

        # Import paradigm config for prompt customization
        from .paradigm_config import get_paradigm_config
        self.paradigm_config = get_paradigm_config(paradigm_key)
