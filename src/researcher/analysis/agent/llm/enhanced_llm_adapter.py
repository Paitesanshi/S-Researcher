...
def main():
    ...
    parser.add_argument("--config-name", default="default-chat", help="Model config name defined in config/model_config.json (default: default-chat)")
