...
def bayesian_simple_regression(x, y):
    ...
    """
    if pm is None:
        raise ImportError("pymc is not installed. Please install it to use Bayesian Simple Regression.")
...
def bayesian_hierarchical_regression(df):
    ...
    """
    if pm is None:
        raise ImportError("pymc is not installed. Please install it to use Bayesian Hierarchical Regression.")
