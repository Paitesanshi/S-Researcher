...
"""
    ...
    def _get_paradigm_discussion_focus(self, paradigm: str) -> str:
        ...
        focus_map = {
            ...
            "deductive": "Compare hypothesis performance, discuss theoretical implications of best-fitting hypothesis, and suggest theory refinements.",
            "inductive": "Analyze inferred mechanisms, discuss theoretical grounding, and propose mechanism-based explanations.",
            "abductive": "Interpret causal effect sizes, discuss practical intervention strategies, and evaluate dose-response relationships.",
