...
Reference figures in text using \\ref{{fig:labelname}}."""
    ...
    def _get_paradigm_results_focus(self, paradigm: str) -> str:
        ...
        focus_map = {
            ...
            "deductive": "Present comparative hypothesis validation results, statistical comparisons, and best-fitting hypothesis identification.",
            "inductive": "Highlight emergent patterns from simulation, behavioral regularities, and mechanism inference evidence.",
            "abductive": "Quantify causal effects, present dose-response curves, and identify critical thresholds.",
